...
describe ::YeSQL::Bindings::Extract do
  describe '.call' do
    ...
    subject do
      described_class.new(indexed_bindings,
                          hash,
                          index,
                          value)
    end
    ...
    context '1st element in `indexed_bindings`' do
      ...
      it { expect(subject.bind_vars).to eq('$1') }
    ...
    context '2nd element in `indexed_bindings`' do
      ...
      it { expect(subject.bind_vars).to eq('$2, $3') }
    ...
    context '3rd element in `indexed_bindings`' do
      ...
      it { expect(subject.bind_vars).to eq('$4') }
    ...
    context '3rd element in `indexed_bindings`' do
      ...
      it { expect(subject.bind_vars).to eq('$5, $6, $7') }
